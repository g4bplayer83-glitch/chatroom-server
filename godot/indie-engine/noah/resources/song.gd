...
## Stable identifier used by converted mods and save data.
...
## Optional engine-specific data. Kept separate from chart data so converted
## projects can retain their original stage, character and menu information.
